...
import { LayoutGrid, CalendarClock, LineChart, Brain, Settings, ChevronsUpDown, Plus, Check, Images, MessageSquare, MessagesSquare, Eraser, PenLine, Wand2, Target, LayoutTemplate } from 'lucide-react';
